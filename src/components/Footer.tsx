    ...
    <footer className="bg-primary text-soft-white mt-auto">
      <div className="w-full py-20 px-margin-mobile md:px-margin-desktop grid grid-cols-1 md:grid-cols-4 gap-gutter max-w-container-max mx-auto">
        <div className="md:col-span-1">
          <span className="font-poppins text-2xl font-semibold mb-4 block">Refugio Outdoor</span>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="flex gap-4 mt-2">
            <button className="text-soft-white hover:text-burnt-orange transition-colors"><Globe size={20} /></button>
            <button className="text-soft-white hover:text-burnt-orange transition-colors"><Share2 size={20} /></button>
          </div>
        </div>
      </div>
