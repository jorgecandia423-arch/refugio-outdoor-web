      ...
      <section className="py-20 bg-soft-white">
        <div className="max-w-container-max mx-auto px-margin-desktop">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-end">
            ...
            <div className="md:col-span-5 bg-kraft-beige p-8 border-l-4 border-burnt-orange mt-8 md:mt-0">
              <div className="flex items-center gap-4 mb-4">
                <span className="material-symbols-outlined text-burnt-orange text-2xl">verified</span>
        ...
        <div className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-gutter items-center">
            ...
            <div className="md:col-span-5 md:col-start-8 mt-8 md:mt-0">
              <span className="font-montserrat text-xs uppercase tracking-widest text-burnt-orange mb-4 block font-bold">Responsabilidad Ambiental</span>
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-kraft-beige text-burnt-orange rounded-full">
